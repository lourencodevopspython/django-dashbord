...
from .models import Vendas, Produto, Vendedor, Despesa
...
def retorna_total_despesa(request):
    total = Despesa.objects.all().aggregate(Sum('total'))['total__sum']
...
def retorna_total_lucro(request):
    total_despesa = Despesa.objects.all().aggregate(Sum('total'))['total__sum']
    total_vendas = Vendas.objects.all().aggregate(Sum('total'))['total__sum']
    total = total_vendas - total_despesa
